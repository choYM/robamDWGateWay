...
public class BasOrganization {
	...
	private String organization_function;
	...
	private String belonged_channel_no;
	...
	private String pladform_no;
	private String pladform_name;
	private String is_opened_invoice;
	private String income_organization;
	...
	private String income_organization_name;
	private String application_organization_name;
	...
	private List<BasOrganization> information_list;
	private List<OrgAddress> contact_address_list;
	...
	public String getOrganization_function() {
		return organization_function;
	}
	public void setOrganization_function(String organization_function) {
		this.organization_function = organization_function;
	}
	...
	public String getBelonged_channel_no() {
		return belonged_channel_no;
	}
	public void setBelonged_channel_no(String belonged_channel_no) {
		this.belonged_channel_no = belonged_channel_no;
	}
	...
	public String getPladform_no() {
		return pladform_no;
	}
	public void setPladform_no(String pladform_no) {
		this.pladform_no = pladform_no;
	}
	public String getPladform_name() {
		return pladform_name;
	}
	public void setPladform_name(String pladform_name) {
		this.pladform_name = pladform_name;
	}
	public String getIs_opened_invoice() {
		return is_opened_invoice;
	}
	public void setIs_opened_invoice(String is_opened_invoice) {
		this.is_opened_invoice = is_opened_invoice;
	}
	public String getIncome_organization() {
		return income_organization;
	}
	public void setIncome_organization(String income_organization) {
		this.income_organization = income_organization;
	}
	public String getIs_auto_confirm() {
		return is_auto_confirm;
	}
	public void setIs_auto_confirm(String is_auto_confirm) {
		this.is_auto_confirm = is_auto_confirm;
	}
	...
	public String getIncome_organization_name() {
		return income_organization_name;
	}
	public void setIncome_organization_name(String income_organization_name) {
		this.income_organization_name = income_organization_name;
	}
	public String getApplication_organization_name() {
		return application_organization_name;
	}
	public void setApplication_organization_name(String application_organization_name) {
		this.application_organization_name = application_organization_name;
	}
	...
	public List<BasOrganization> getInformation_list() {
		return information_list;
	}
	public void setInformation_list(List<BasOrganization> information_list) {
		this.information_list = information_list;
	}
	public List<OrgAddress> getContact_address_list() {
		return contact_address_list;
	}
	public void setContact_address_list(List<OrgAddress> contact_address_list) {
