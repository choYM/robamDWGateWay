...
import com.robam.distribution.base.service.IPriceZoneService;
...
public class PriceZoneService implements IPriceZoneService {
	@Autowired
	private  Dao dao;
	@Override
	public Object getPriceZoneList(int startPage, int pageSize,
		...
		profile.put("description", "查询数据成功");
	...
	@Override
	public Object deletePriceZone(List<Map<String,Object>> param)
			throws Exception {
		...
		for(Map<String,Object> map : param){
			...
			count += dao.delete("dao.BaseApplicationCategoryCodesSettingMapper.deletePriceZone", map);
		}
	...
	@Override
	public Object auditPriceZone(List<Map<String,Object>> param,
	...
	public Object addPriceZone(Map<String, Object> param) throws Exception {
		...
		List<Integer> data = this.dao.query("dao.BaseApplicationCategoryCodesSettingMapper.judgePriceZone", param);
		...
		if(data.size() > 0 && data.get(0) == 0){
			...
			count = this.dao.insert("dao.BaseApplicationCategoryCodesSettingMapper.addPriceZone", param);
		}
	...
	public Object getPriceZone(Map<String, Object> param) throws Exception {
		...
		Object data = this.dao.query("dao.BaseApplicationCategoryCodesSettingMapper.getPriceZone", param);
		if (data!=null) {
